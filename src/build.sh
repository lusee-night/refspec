...
g++ -I../include -I../extern -O3 -Wall -shared -std=c++17 -fPIC $(python3 -m pybind11 --includes) \
refspec.cpp SpecConfig.cpp SpecOutput.cpp SignalGenerator.cpp RefSpectrometer.cpp pfb.cpp \
